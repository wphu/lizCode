...
if __name__ == "__main__":
    ...
    nz_source = 20
    nz_base = 3
    n_gap_width = 0.5e-3 / dx
    n_tile_half = 0.5e-3 / dx
    ...
    bndr_type[0, , 0 : n_tile_half, 0 : ny_wall_boundary] = 1
    bndr_val [0, , 0 : n_tile_half, 0 : ny_wall_boundary] = wall_potential
    ...
    ## west of south surface
    bndr_type[0, , 0 : n_tile_half, 0 : ny_wall_boundary] = 5
    bndr_val [0, , 0 : n_tile_half, 0 : ny_wall_boundary] = wall_potential
    ## east of south surface
    bndr_type[0, , 0 : n_tile_half, 0 : ny_wall_boundary] = 5
    bndr_val [0, , 0 : n_tile_half, 0 : ny_wall_boundary] = wall_potential
