...
particle_flux_normalize = 1.0
heat_flux_normalize = 1.0
...
print("e particle flux: ",val_2d[0,0], val_2d[0,20], val_2d[0].max())
print("D1 particle flux: ",val_2d[1,0], val_2d[1,20], val_2d[1].max())

ax0.grid(True)

ax0.legend(loc = 2, framealpha=1)
ax0.set_xlim((xmin, xmax))
#ax0.set_ylim((0.0, 5.0))
#y_major_ticks = np.arange(0, 5.0, 2.0)
...
print("e heat flux: ",val_2d[0,0], val_2d[0,20], val_2d[0].max())
print("D1 heat flux: ",val_2d[1,0], val_2d[1,20], val_2d[1].max())
