...
// Constructor
Collisions2D_Coulomb::Collisions2D_Coulomb(PicParams& params, vector<Species*>& vecSpecies, SmileiMPI* smpi,
...
void Collisions2D_Coulomb::collide(PicParams& params, SmileiMPI* smpi, ElectroMagn* fields, vector<Species*>& vecSpecies, Diagnostic* diag, int itime)
{
