...
public:
    ...
    virtual void gatherField0( Field* field_global ,Field* field  ){};
    //gatherField1: values at the nodes, like density
    virtual void gatherField1( Field* field_global ,Field* field  ){};
    //gatherField2: average values in the cells, like temperature, velocity
    virtual void gatherField2( Field* field_global ,Field* field  ){};
    //gatherField1_all: gather fields to all processes
    virtual void gatherField1_all( Field* field_global ,Field* field  ){};
