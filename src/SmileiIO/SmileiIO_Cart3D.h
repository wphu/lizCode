...
public:
    ...
    SmileiIO_Cart3D( PicParams& params, SmileiMPI* smpi, ElectroMagn* fields, vector<Species*>& vecSpecies);
    ...
    // Create particles h5 file pattern
    void createDiagsPattern( PicParams& params, Diagnostic3D* diag3D);
