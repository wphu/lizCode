...
Diagnostic(params)
{
    ...
    {
        particleFlux[ispec] = new Field2D(dim, params.species_param[ispec].species_type);
        heatFlux[ispec] = new Field2D(dim, params.species_param[ispec].species_type);
        averageAngle[ispec] = new Field2D(dim, params.species_param[ispec].species_type);
    ...
    {
        psiRate[ipsi] = new Field2D(dim, "psiRate");
